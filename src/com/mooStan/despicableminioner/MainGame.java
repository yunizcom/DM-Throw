...
import com.mooStan.despicableminioner.R;
...
public class MainGame extends Activity implements OnGestureListener {
...
public static final String PREFS_NAME = "YunizMtSaves";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Typeface tf = Typeface.createFromAsset(getAssets(), "fonts/Cartoon_Regular.ttf");
		
		gameScore.setTypeface(tf);
		resultTxt.setTypeface(tf);
		
		txtNo1.setTypeface(tf);
		txtNick1.setTypeface(tf);
		txtScore1.setTypeface(tf);
		txtNo2.setTypeface(tf);
		txtNick2.setTypeface(tf);
		txtScore2.setTypeface(tf);
		txtNo3.setTypeface(tf);
		txtNick3.setTypeface(tf);
		txtScore3.setTypeface(tf);
		txtNo4.setTypeface(tf);
		txtNick4.setTypeface(tf);
		txtScore4.setTypeface(tf);
		txtNo5.setTypeface(tf);
		txtNick5.setTypeface(tf);
		txtScore5.setTypeface(tf);
		txtNo6.setTypeface(tf);
		txtNick6.setTypeface(tf);
		txtScore6.setTypeface(tf);
		txtNo7.setTypeface(tf);
		txtNick7.setTypeface(tf);
		txtScore7.setTypeface(tf);
		txtNo8.setTypeface(tf);
		txtNick8.setTypeface(tf);
		txtScore8.setTypeface(tf);
		txtNo9.setTypeface(tf);
		txtNick9.setTypeface(tf);
		txtScore9.setTypeface(tf);
		txtNo10.setTypeface(tf);
		txtNick10.setTypeface(tf);
		txtScore10.setTypeface(tf);
		...
		try 
		{
		    ...
		    ims1 = getAssets().open("minion_9.png");
		    d1 = Drawable.createFromStream(ims1, null);
